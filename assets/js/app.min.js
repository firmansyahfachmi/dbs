                        ...
                        if(e.path == 'all'){
                            if(e.data.length>0) {
                                ...
                                $.each(e.data, function(idx, item){
                                    $(".board-body .winner-list").append('<div class="list-row"><div class="list-cell">'+ zeroPad(rankNum++, 2) +'</div><div class="list-cell">'+ item.name +'</div><div class="list-cell">'+ item.total_score +'</div></div>');
                                });
                            } else {
...
function pilihData(e) {
  ...
  $.ajax({
    dataType: 'json',
    url: baseUrlCms + '/backend/api/user/getQuiz',
    ...
    success: function (data) {
      ...
      if (data.quis != '' && data.quis != null) {
        ...
        htmlData += '<br><br><a href="#" data-id="' + data.id + '" class="' + btnAktif1 + ' btn_true btn btn-red font-size-18">True</a>'+
          '<a data-id="' + data.id + '" href="#" style="background:#ededed;" class="' + btnAktif2 + ' btn_false btn btn-default font-size-18">False</a>';
        }
        htmlData += '</div>';
      } else {
        htmlData += '<div>'
