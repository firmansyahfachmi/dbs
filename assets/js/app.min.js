...
function changeType(x){
  typeBoard = x
  getResponse(typeBoard, placeBoard)
}
...
function getResponse(e, place) {
  var baseUrlCms = $("#baseUrlCms").val()
  var rankNum = 1
  var t
  switch (e) {
    case "all":
      e = `/backend/api/user/getScore?location=${place}`
      break
    case "week":
      e = `/backend/api/user/getScore/week?location=${place}`
      break
    case "month":
      e = `/backend/api/user/getScore/month?location=${place}`
  }
  return (
    e
      ? $.ajax({
...
function setTourLocation() {
  if (placed == "ciputra") {
    $("#next-location").prop("href", "dbs-tower-ciputra-world/tour.html")
  } else if (placed == "juanda") {
    $("#next-location").prop("href", "dbs-juanda/tour.html")
  } else if (placed == "capital") {
    $("#next-location").prop("href", "dbs-tower-capital-place/tour.html")
  }
}
