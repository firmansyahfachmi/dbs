...
function sendAnswer(jawaban, data_id) {
  ...
  $.ajax({
    dataType: "json",
    url: baseUrlCms + "/backend/api/user/sendAnswer?location=juanda",
    data:
      "data_id=" +
      data_id +
      "&info_time=" +
...
function pilihData(e) {
  ...
  $.ajax({
    dataType: "json",
    url: baseUrlCms + "/backend/api/user/getQuiz?location=juanda",
...
function TotaltriggerPin() {
  ...
  $.ajax({
    dataType: "json",
    url: baseUrlCms + "/backend/api/user/userPointTotal?session_id="+session_ids+"&location=juanda",
    type: "POST",
    success: function (data) {
